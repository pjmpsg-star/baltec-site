...
const tabs = [
  ...
  { label: "Roller Forming", href: "/product/roller-forming", active: true},
   ...
   <section className="w-full bg-white py-10 md:py-16">
      <div className="mx-auto max-w-5xl px-4 md:px-0">
        ...
        <div className="w-full mb-12">
          <Image
            src="/sub_cont02_04_01.jpg"   // ★ 여기에 첫 번째 사진 경로
            alt="image1"
            width={1600}
            height={1000}
        ...
        <div className="w-full mb-12">
          <div className="relative w-full" style={{ paddingBottom: "56.25%" }}>
            <iframe
              ...
              src="https://www.youtube.com/embed/a_Skkvpf7cU"   // ★ 유튜브 주소
              title="video"
